...
import os
from libs.conf import fetch_args
server = fetch_args("SERVER")
debug = fetch_args("DEBUG")
log = fetch_args("LOGDIR")
...
SECRET_KEY = 'z(mk5f08_9bpm=3v75cpjip33ridqhqz1rdr19guk(ty2f67=p'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file':{
            ...
            'filename': log.get("log_dir") + log.get("log_file"),
            'formatter':'standard',
        }
    },
    'loggers': {
